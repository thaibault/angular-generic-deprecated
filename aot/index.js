...
import { ChangeDetectionStrategy, ChangeDetectorRef, Component, ContentChild, Directive, ElementRef, EventEmitter, forwardRef, Injectable, 
...
PLATFORM_ID, 
/* eslint-enable no-unused-vars */
ReflectiveInjector, Renderer2, TemplateRef, ViewChild, ViewContainerRef } from '@angular/core';
...
export const TINY_MCE_DEFAULT_OPTIONS = Tools.extendObject(true, tinymceDefaultSettings, {
...
class InitialDataService {
    ...
    constructor(tools) {
        ...
        this.set(this.constructor.defaultScope, tools.globalContext.genericInitialData || {});
        if (this.constructor.removeFoundData)
            delete tools.globalContext.genericInitialData;
        if ('document' in tools.globalContext &&
            'querySelector' in tools.globalContext.document) {
            // TODO how to get right dom node?
            const domNode = tools.globalContext.document.querySelector('application');
...
InitialDataService = __decorate([
     ...
     */
    ,
    __metadata("design:paramtypes", [ToolsService])
], InitialDataService);
...
for (const methodTypePrefix in methodGroups)
    if (methodGroups.hasOwnProperty(methodTypePrefix)) {
        ...
        if (methodGroups[methodTypePrefix] === '*')
            ...
            for (const name of Object.getOwnPropertyNames(Tools)) {
                if (Tools.hasOwnProperty(name) && Tools.hasOwnProperty(name) && (new RegExp(`^${methodTypePrefix}[A-Z0-9]`)).test(name))
                    methodNames.push(name);
            }
        else
            methodNames = methodGroups[methodTypePrefix];
        for (const methodName of methodNames) {
            const pipeName = Tools.stringCapitalize(methodName);
            ...
            Pipe({ name: `generic${pipeName}` })(module.exports[`${pipeName}Pipe`]);
            if (invert.includes(methodTypePrefix)) {
                module.exports[`${pipeName}InvertedPipe`] = class {
                     ...
                     */
                    transform(...parameter) {
                        const tools = ReflectiveInjector.resolveAndCreate([
                            ToolsService
                        ]).get(ToolsService).tools;
                        // IgnoreTypeCheck
                        return tools.invertArrayFilter(tools[methodName])(...parameter);
                    }
                };
                Pipe({ name: `generic${pipeName}Inverted` })(module.exports[`${pipeName}InvertedPipe`]);
            }
        }
    }
const ArrayMakeRangePipe = module.exports.ArrayMakeRangePipe;
const EqualsPipe = module.exports.EqualsPipe;
const ExtendObjectPipe = module.exports.ExtendObjectPipe;
const NumberGetUTCTimestampPipe = module.exports.NumberGetUTCTimestampPipe;
const RepresentObjectPipe = module.exports.RepresentObjectPipe;
const StringCapitalizePipe = module.exports.StringCapitalizePipe;
const StringEscapeRegularExpressionsPipe = module.exports.StringEscapeRegularExpressionsPipe;
const StringFormatPipe = module.exports.StringFormatPipe;
const StringMD5Pipe = module.exports.StringMD5Pipe;
// / endregion
// / region object
// IgnoreTypeCheck
let AttachmentsAreEqualPipe = 
/**
 ...
 */
class AttachmentsAreEqualPipe /* implements PipeTransform*/ {
    /**
    ...
    async transform(first, second) {
        ...
        */
        ...
        const data = { first: { given: first }, second: { given: second } };
...
AttachmentsAreEqualPipe = __decorate([
     ...
     */
    ,
    __metadata("design:paramtypes", [InitialDataService,
        Injector,
        NgZone, Object, Object])
], AttachmentsAreEqualPipe);
export { AttachmentsAreEqualPipe };
// IgnoreTypeCheck
let GetFilenameByPrefixPipe = 
/**
 * Retrieves a matching filename by given filename prefix.
 */
class GetFilenameByPrefixPipe /* implements PipeTransform*/ {
    /**
     * Performs the actual transformations process.
...
GetFilenameByPrefixPipe = __decorate([
    Pipe({ name: 'genericGetFilenameByPrefix' })
    /**
     * Retrieves a matching filename by given filename prefix.
     */
], GetFilenameByPrefixPipe);
export { GetFilenameByPrefixPipe };
// IgnoreTypeCheck
let AttachmentWithPrefixExistsPipe = 
/**
 ...
 * function.
 */
class AttachmentWithPrefixExistsPipe /* implements PipeTransform*/ {
    /**
...
AttachmentWithPrefixExistsPipe = __decorate([
     ...
     */
    ,
    __metadata("design:paramtypes", [GetFilenameByPrefixPipe,
        InitialDataService])
], AttachmentWithPrefixExistsPipe);
export { AttachmentWithPrefixExistsPipe };
// IgnoreTypeCheck
let ExtractDataPipe = 
/**
 ...
 */
class ExtractDataPipe /* implements PipeTransform*/ {
    /**
...
export { ExtractDataPipe };
// IgnoreTypeCheck
let ExtractRawDataPipe = 
/**
 ...
 */
class ExtractRawDataPipe /* implements PipeTransform*/ {
    /**
     * Gets injected services.
     ...
     * @returns Nothing.
     */
    constructor(attachmentsAreEqualPipe, equalsPipe, initialData, injector, numberGetUTCTimestampPipe, tools) {
...
ExtractRawDataPipe = __decorate([
     ...
     */
    ,
    __metadata("design:paramtypes", [AttachmentsAreEqualPipe, Object, InitialDataService,
        Injector, Object, ToolsService])
], ExtractRawDataPipe);
export { ExtractRawDataPipe };
// IgnoreTypeCheck
let IsDefinedPipe = 
/**
 * Checks if given reference is defined.
 */
class IsDefinedPipe /* implements PipeTransform*/ {
    /**
 ...
 * runtime.
 */
class MapPipe /* implements PipeTransform*/ {
    /**
    ...
    transform(object, pipeName, ...additionalArguments) {
        ...
        for (const key in object)
            if (object.hasOwnProperty(key))
                result[key] = pipe.transform.transform(object[key], key, ...additionalArguments);
        return result;
    }
};
MapPipe = __decorate([
 ...
 */
class TypePipe /* implements PipeTransform*/ {
    /**
...
// region array
// IgnoreTypeCheck
let ArrayDependentConcatPipe = 
/**
 * Dependently concatenate given data to piped data.
 */
class ArrayDependentConcatPipe /* immplements PipeTransform*/ {
    /**
...
ArrayDependentConcatPipe = __decorate([
    Pipe({ name: 'genericArrayDependentConcat' })
    /**
     * Dependently concatenate given data to piped data.
     */
], ArrayDependentConcatPipe);
export { ArrayDependentConcatPipe };
// endregion
// region string
// IgnoreTypeCheck
let StringEndsWithPipe = 
/**
 * Forwards javaScript's native "stringEndsWith" method.
 */
class StringEndsWithPipe /* implements PipeTransform*/ {
    /**
...
StringEndsWithPipe = __decorate([
    Pipe({ name: 'genericStringEndsWith' })
    /**
     * Forwards javaScript's native "stringEndsWith" method.
     */
], StringEndsWithPipe);
export { StringEndsWithPipe };
// IgnoreTypeCheck
let StringHasTimeSuffixPipe = 
/**
 * Determines if given string has a time indicating suffix.
 */
class StringHasTimeSuffixPipe /* implements PipeTransform*/ {
    /**
...
StringMatchPipe = __decorate([
    Pipe({ name: 'genericStringMatch' })
    /**
     * Tests if given pattern matches against given subject.
     */
], StringMatchPipe);
export { StringMatchPipe };
// IgnoreTypeCheck
let StringMaximumLengthPipe = 
/**
 * Trims given string if it is longer then given length.
 */
class StringMaximumLengthPipe /* implements PipeTransform*/ {
    /**
     * Performs the actual indicator method.
     * @param string - To check.
...
StringMaximumLengthPipe = __decorate([
    Pipe({ name: 'genericStringMaximumLength' })
    /**
     * Trims given string if it is longer then given length.
     */
], StringMaximumLengthPipe);
export { StringMaximumLengthPipe };
// IgnoreTypeCheck
let StringReplacePipe = 
/**
 * Provides javascript's native string replacement method as pipe.
 */
class StringReplacePipe /* implements PipeTransform*/ {
    /**
...
StringReplacePipe = __decorate([
    Pipe({ name: 'genericStringReplace' })
    /**
     * Provides javascript's native string replacement method as pipe.
     */
], StringReplacePipe);
export { StringReplacePipe };
// IgnoreTypeCheck
let StringSafeHTMLPipe = 
/**
 * Provides angular dom html sanitizer.
 * @property transform - Binded dom sanitizer's validation marker.
 */
class StringSafeHTMLPipe /* implements PipeTransform*/ {
    /**
     * @param domSanitizer - Injected dom sanitizer service instance.
     * @returns Nothing.
     */
    constructor(domSanitizer) {
        this.transform = domSanitizer.bypassSecurityTrustHtml.bind(this.domSanitizer);
    }
};
StringSafeHTMLPipe = __decorate([
...
export { StringSafeHTMLPipe };
// IgnoreTypeCheck
let StringSafeResourceURLPipe = 
/**
 * Provides angular dom html sanitizer.
 * @property transform - Binded dom sanitizer's validation marker.
 */
class StringSafeResourceURLPipe /* implements PipeTransform*/ {
    /**
     * @param domSanitizer - Injected dom sanitizer service instance.
     * @returns Nothing.
     */
    constructor(domSanitizer) {
        this.transform = domSanitizer.bypassSecurityTrustResourceUrl.bind(this.domSanitizer);
    }
};
StringSafeResourceURLPipe = __decorate([
...
export { StringSafeResourceURLPipe };
// IgnoreTypeCheck
let StringSafeScriptPipe = 
/**
 * Provides angular dom html sanitizer.
 * @property transform - Binded dom sanitizer's validation marker.
 */
class StringSafeScriptPipe /* implements PipeTransform*/ {
    /**
     * @param domSanitizer - Injected dom sanitizer service instance.
     * @returns Nothing.
     */
    constructor(domSanitizer) {
        this.transform = domSanitizer.bypassSecurityTrustScript.bind(this.domSanitizer);
    }
};
StringSafeScriptPipe = __decorate([
...
export { StringSafeScriptPipe };
// IgnoreTypeCheck
let StringSafeStylePipe = 
/**
 * Provides angular dom html sanitizer.
 * @property transform - Binded dom sanitizer's validation marker.
 */
class StringSafeStylePipe /* implements PipeTransform*/ {
    /**
     * @param domSanitizer - Injected dom sanitizer service instance.
     * @returns Nothing.
     */
    constructor(domSanitizer) {
        this.transform = domSanitizer.bypassSecurityTrustStyle.bind(this.domSanitizer);
    }
};
StringSafeStylePipe = __decorate([
...
export { StringSafeStylePipe };
// IgnoreTypeCheck
let StringSafeURLPipe = 
/**
 * Provides angular dom html sanitizer.
 * @property transform - Binded dom sanitizer's validation marker.
 */
class StringSafeURLPipe /* implements PipeTransform*/ {
    /**
     * @param domSanitizer - Injected dom sanitizer service instance.
     * @returns Nothing.
     */
    constructor(domSanitizer) {
        this.transform = domSanitizer.bypassSecurityTrustUrl.bind(this.domSanitizer);
    }
};
StringSafeURLPipe = __decorate([
...
export { StringSafeURLPipe };
// IgnoreTypeCheck
let StringShowIfPatternMatchesPipe = 
/**
 * Returns given string if it matches given pattern.
 */
class StringShowIfPatternMatchesPipe /* implements PipeTransform*/ {
    /**
     * Performs the actual matching.
     * @param string - String to replace content.
    ...
    transform(string, pattern, invert = false, modifier = '') {
        // IgnoreTypeCheck
        let indicator = new RegExp(pattern, modifier).test(string);
        if (invert)
            indicator = !indicator;
        return indicator ? string : '';
    }
};
StringShowIfPatternMatchesPipe = __decorate([
    Pipe({ name: 'genericStringShowIfPatternMatches' })
    /**
     * Returns given string if it matches given pattern.
     */
], StringShowIfPatternMatchesPipe);
export { StringShowIfPatternMatchesPipe };
// IgnoreTypeCheck
let StringSliceMatchPipe = 
/**
 * Returns a matched part of given subject with given pattern. Default is the
 * whole (zero) matched part.
 */
class StringSliceMatchPipe /* implements PipeTransform*/ {
    /**
     * Performs the actual matching.
     * @param subject - String to search in.
     * @param pattern - String or regular expression to search for.
...
StringSliceMatchPipe = __decorate([
...
export { StringSliceMatchPipe };
// IgnoreTypeCheck
let StringStartsWithPipe = 
/**
 * Forwards javascript's native "stringStartsWith" method.
 */
class StringStartsWithPipe /* implements PipeTransform*/ {
    /**
     * Performs the actual indicator method.
     * @param string - To check.
...
// / region number
// IgnoreTypeCheck
let NumberPercentPipe = 
/**
 * Returns part in percent of all.
 */
class NumberPercentPipe /* implements PipeTransform*/ {
    /**
...
NumberPercentPipe = __decorate([
    Pipe({ name: 'genericNumberPercent' })
    /**
     * Returns part in percent of all.
     */
], NumberPercentPipe);
export { NumberPercentPipe };
// / endregion
// endregion
// region services
// IgnoreTypeCheck
let CanDeactivateRouteLeaveGuard = 
/**
 ...
 * a boolean.
 */
class CanDeactivateRouteLeaveGuard /* implements CanDeactivate<Object>*/ {
    /**
...
CanDeactivateRouteLeaveGuard = __decorate([
    Injectable()
    /**
     * A generic guard which prevents from switching to route if its component's
     * "canDeactivate()" method returns "false", a promise or observable wrapping
...
export { CanDeactivateRouteLeaveGuard };
// / region confirm
// IgnoreTypeCheck
...
], ConfirmComponent.prototype, "cancelText", void 0);
__decorate([
    Input(),
    __metadata("design:type", String)
], ConfirmComponent.prototype, "okText", void 0);
ConfirmComponent = __decorate([
     ...
     */
    ,
    __param(0, Optional()), __param(0, Inject(MAT_DIALOG_DATA)),
    __param(1, Optional()),
...
class DataService {
     ...
     * @returns Nothing.
     */
    constructor(equalsPipe, extendObjectPipe, initialData, ngZone, platformID, stringFormatPipe, tools) {
        this.interceptSynchronisationPromise = null;
        this.middlewares = {
            post: {},
            pre: {}
        };
     ...
     */
    async initialize() {
        const options = this.extendObject(
        /* eslint-disable camelcase */
        ...
        */
        ...
        for (const name in this.connection)
            if (this.constructor.wrappableMethodNames.includes(name) &&
        ...
        if (isPlatformServer(this.platformID) &&
            ...
            for (const modelName in this.configuration.database.model.entities)
                if (this.configuration.database.model.entities.hasOwnProperty(modelName) && (new RegExp(this.configuration.database.model.property.name
                    ...
                    for (const name of DataService_1.determineGenericIndexablePropertyNames(this.configuration.database.model, this.configuration.database.model.entities[modelName]))
                        try {
                ...
                if (index.name.endsWith('-GenericIndex')) {
                    ...
                    for (const modelName in this.configuration.database.model.entities)
                        if (index.name.startsWith(`${modelName}-`)) {
                            for (const name of DataService_1
    ...
    async get(...parameter) {
        ...
        if (LAST_KNOWN_DATA.data.hasOwnProperty(result[idName]) &&
            ...
            parseInt(result[revisionName].match(this.constructor.revisionNumberRegularExpression)[1]) < parseInt(LAST_KNOWN_DATA.data[result[idName]][revisionName].match(this.constructor.revisionNumberRegularExpression)[1]))
...
DataService.revisionNumberRegularExpression = /^([0-9]+)-/;
...
DataService = DataService_1 = __decorate([
    ...
    __metadata("design:paramtypes", [Object, Object, InitialDataService,
        NgZone, String, Object, ToolsService])
], DataService);
export { DataService };
// IgnoreTypeCheck
let DataScopeService = 
/**
...
class DataScopeService {
     ...
     * @returns Nothing.
     */
    constructor(attachmentWithPrefixExistsPipe, data, extendObjectPipe, extractDataPipe, getFilenameByPrefixPipe, initialData, numberGetUTCTimestampPipe, representObjectPipe, tools) {
                        ...
                        if (Object.keys(data).length === 0)
                            for (const hookType of [
                                ...
                                if (result[name][type].hasOwnProperty(hookType) && result[name][type][hookType]) {
                                    result[name][type].value = (new Function('newDocument', 'oldDocument', 'userContext', 'securitySettings', 'name', 'models', 'modelConfiguration', 'serialize', 'modelName', 'model', 'propertySpecification', 'now', 'nowUTCTimestamp', 'getFilenameByPrefix', 'attachmentWithPrefixExists', (hookType.endsWith('Expression') ? 'return ' : '') + result[name][type][hookType]))(data, null, {}, {}, type, entities, this.configuration.database.model, (object) => JSON.stringify(object, null, 4), modelName, modelSpecification, result[name][type], now, nowUTCTimestamp, this.getFilenameByPrefix, this.attachmentWithPrefixExists.bind(data, data), result[name][type]);
                ...
                if (Object.keys(data).length === 0)
                    for (const type of [
                        ...
                        if (result[name].hasOwnProperty(type) &&
                            result[name][type]) {
                            result[name].value = (new Function('newDocument', 'oldDocument', 'userContext', 'securitySettings', 'name', 'models', 'modelConfiguration', 'serialize', 'modelName', 'model', 'propertySpecification', 'now', 'nowUTCTimestamp', 'getFilenameByPrefix', 'attachmentWithPrefixExists', (type.endsWith('Expression') ? 'return ' :
                                '') + result[name][type]))(data, null, {}, {}, name, entities, this.configuration.database.model, (object) => JSON.stringify(object, null, 4), modelName, modelSpecification, result[name], now, nowUTCTimestamp, this.getFilenameByPrefix, this.attachmentWithPrefixExists.bind(data, data), result[name]);
...
DataScopeService = __decorate([
     ...
     */
    ,
    __metadata("design:paramtypes", [AttachmentWithPrefixExistsPipe,
        DataService, Object, ExtractDataPipe,
        GetFilenameByPrefixPipe,
        InitialDataService, Object, Object, ToolsService])
], DataScopeService);
export { DataScopeService };
// / region abstract
// IgnoreTypeCheck
let AbstractResolver = 
/**
 ...
 * implementations.
 */
class AbstractResolver /* implements Resolve<PlainObject>*/ {
    /**
    ...
    list(sort = [{
        ...
        */
        const options = { skip: Math.max(page - 1, 0) * limit };
...
], AbstractInputComponent.prototype, "declaration", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], AbstractInputComponent.prototype, "description", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], AbstractInputComponent.prototype, "disabled", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], AbstractInputComponent.prototype, "maximum", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], AbstractInputComponent.prototype, "maximumLength", void 0);
__decorate([
    Input(),
    __metadata("design:type", String)
], AbstractInputComponent.prototype, "maximumLengthText", void 0);
__decorate([
    Input(),
    __metadata("design:type", String)
], AbstractInputComponent.prototype, "maximumText", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], AbstractInputComponent.prototype, "minimum", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], AbstractInputComponent.prototype, "minimumLength", void 0);
__decorate([
    Input(),
    __metadata("design:type", String)
], AbstractInputComponent.prototype, "minimumLengthText", void 0);
__decorate([
    Input(),
    __metadata("design:type", String)
], AbstractInputComponent.prototype, "minimumText", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], AbstractInputComponent.prototype, "model", void 0);
__decorate([
    Output(),
    __metadata("design:type", EventEmitter)
], AbstractInputComponent.prototype, "modelChange", void 0);
__decorate([
    Input(),
    __metadata("design:type", String)
], AbstractInputComponent.prototype, "pattern", void 0);
__decorate([
    Input(),
    __metadata("design:type", String)
], AbstractInputComponent.prototype, "patternText", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
...
__decorate([
    Input(),
    __metadata("design:type", String)
], AbstractInputComponent.prototype, "requiredText", void 0);
__decorate([
    Input(),
    __metadata("design:type", String)
], AbstractInputComponent.prototype, "showDeclarationText", void 0);
__decorate([
    Input(),
    __metadata("design:type", Boolean)
], AbstractInputComponent.prototype, "showValidationErrorMessages", void 0);
__decorate([
    Input(),
    __metadata("design:type", String)
 ...
 * converter pipe transform method.
 */
let AbstractNativeInputComponent = class AbstractNativeInputComponent extends AbstractInputComponent {
    /**
...
AbstractNativeInputComponent = __decorate([
    __param(0, Optional()),
    __metadata("design:paramtypes", [Injector])
], AbstractNativeInputComponent);
export { AbstractNativeInputComponent };
/**
 ...
 */
let AbstractLiveDataComponent = class AbstractLiveDataComponent /* implements OnDestroy, OnInit*/ {
    /**
    ...
    ngOnInit() {
        const initialize = this._tools.debounce(() => {
            this._changesStream = this._data.connection.changes(this._extendObject(true, {}, { since: LAST_KNOWN_DATA.sequence }, this.constructor.defaultLiveUpdateOptions, this._liveUpdateOptions));
...
AbstractLiveDataComponent = __decorate([
    __param(0, Optional()),
    __metadata("design:paramtypes", [Injector])
], AbstractLiveDataComponent);
export { AbstractLiveDataComponent };
/* eslint-disable brace-style */
/**
 ...
 */
let AbstractItemsComponent = class AbstractItemsComponent extends AbstractLiveDataComponent {
    /**
     * Saves injected service instances as instance properties.
     * @param injector - Application specific injector to use instead auto
     * detected one.
    ...
    constructor(injector) {
        ...
        */
        ...
        this._subscriptions.push(this._route.data.subscribe((data) => {
            ...
            const total = data.items.length + (Math.max(1, this.page || 1) - 1) * this.limit;
...
AbstractItemsComponent = __decorate([
    __param(0, Optional()),
    __metadata("design:paramtypes", [Injector])
], AbstractItemsComponent);
export { AbstractItemsComponent };
/**
...
export class AbstractValueAccessor extends DefaultValueAccessor {
    ...
    constructor(injector) {
        ...
        this.onChangeCallback = Tools.noop;
        this.onTouchedCallback = Tools.noop;
    }
    /**
     ...
     * @returns The transformed give value.
     */
    _handleInput(value, ...additionalParameter) {
        return super._handleInput(this.import(value, ...additionalParameter), ...additionalParameter);
    }
}
__decorate([
    Input(),
    __metadata("design:type", Object)
], AbstractValueAccessor.prototype, "type", void 0);
// / endregion
// // region date/time
// IgnoreTypeCheck
let GenericDateDirective = 
/**
...
__decorate([
    ...
    __metadata("design:type", Object),
    __metadata("design:paramtypes", [Object])
], GenericDateDirective.prototype, "insertOptions", null);
GenericDateDirective = __decorate([
     ...
     */
    ,
    __metadata("design:paramtypes", [DatePipe, Object, TemplateRef,
        ViewContainerRef])
], GenericDateDirective);
export { GenericDateDirective };
// IgnoreTypeCheck
let GenericSliderDirective = 
/**
 * TODO
 */
class GenericSliderDirective {
    /**
     * Saves injected services as instance properties.
     * @param extendObjectPipe - Injected extend object pipe service instance.
     * @param templateReference - Specified template reference.
...
__decorate([
    ...
    __metadata("design:type", Object),
    __metadata("design:paramtypes", [Object])
], GenericSliderDirective.prototype, "insertOptions", null);
GenericSliderDirective = __decorate([
    Directive({ selector: '[genericSlider]' })
    /**
     * TODO
     */
    ,
    __metadata("design:paramtypes", [Object, TemplateRef,
        ViewContainerRef])
], GenericSliderDirective);
export { GenericSliderDirective };
// IgnoreTypeCheck
let DateTimeValueAccessor = DateTimeValueAccessor_1 = 
/**
 * Time value accessor with "ngModel" support.
 */
class DateTimeValueAccessor extends AbstractValueAccessor {
    /**
...
DateTimeValueAccessor = DateTimeValueAccessor_1 = __decorate([
    Directive(Tools.extendObject(true, {}, DefaultValueAccessor.decorators[0].args[0], { providers: [{
                provide: NG_VALUE_ACCESSOR,
                useExisting: forwardRef(() => DateTimeValueAccessor_1),
                multi: true
            }] }))
    /**
     * Time value accessor with "ngModel" support.
...
export { DateTimeValueAccessor };
// // / region interval
// IgnoreTypeCheck
let IntervalInputComponent = 
/**
...
__decorate([
    Input(),
    __metadata("design:type", Object)
], IntervalInputComponent.prototype, "endDeclaration", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], IntervalInputComponent.prototype, "startDeclaration", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], IntervalInputComponent.prototype, "endDescription", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], IntervalInputComponent.prototype, "startDescription", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], IntervalInputComponent.prototype, "endDisabled", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], IntervalInputComponent.prototype, "startDisabled", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], IntervalInputComponent.prototype, "endMaximum", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], IntervalInputComponent.prototype, "startMaximum", void 0);
__decorate([
    Input(),
    __metadata("design:type", String)
], IntervalInputComponent.prototype, "endMaximumText", void 0);
__decorate([
    Input(),
    __metadata("design:type", String)
], IntervalInputComponent.prototype, "startMaximumText", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], IntervalInputComponent.prototype, "endMinimum", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], IntervalInputComponent.prototype, "startMinimum", void 0);
__decorate([
    Input(),
    __metadata("design:type", String)
], IntervalInputComponent.prototype, "endMinimumText", void 0);
__decorate([
    Input(),
    __metadata("design:type", String)
], IntervalInputComponent.prototype, "startMinimumText", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], IntervalInputComponent.prototype, "endRequired", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], IntervalInputComponent.prototype, "startRequired", void 0);
__decorate([
    Input(),
    __metadata("design:type", String)
], IntervalInputComponent.prototype, "endRequiredText", void 0);
__decorate([
    Input(),
    __metadata("design:type", String)
], IntervalInputComponent.prototype, "startRequiredText", void 0);
__decorate([
    Input(),
    __metadata("design:type", String)
], IntervalInputComponent.prototype, "endShowDeclarationText", void 0);
__decorate([
    Input(),
    __metadata("design:type", String)
], IntervalInputComponent.prototype, "startShowDeclarationText", void 0);
__decorate([
    Input(),
    __metadata("design:type", Boolean)
], IntervalInputComponent.prototype, "endShowValidationErrorMessages", void 0);
__decorate([
    Input(),
    __metadata("design:type", Boolean)
], IntervalInputComponent.prototype, "startShowValidationErrorMessages", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], IntervalInputComponent.prototype, "model", void 0);
__decorate([
    Output(),
    __metadata("design:type", EventEmitter)
], IntervalInputComponent.prototype, "modelChange", void 0);
...
export { IntervalInputComponent };
// IgnoreTypeCheck
let IntervalsInputComponent = 
/**
...
__decorate([
    Input(),
    __metadata("design:type", Object)
], IntervalsInputComponent.prototype, "additionalObjectData", void 0);
__decorate([
    ContentChild(TemplateRef),
    __metadata("design:type", TemplateRef)
], IntervalsInputComponent.prototype, "contentTemplate", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], IntervalsInputComponent.prototype, "description", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], IntervalsInputComponent.prototype, "endDeclaration", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], IntervalsInputComponent.prototype, "startDeclaration", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], IntervalsInputComponent.prototype, "endDescription", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], IntervalsInputComponent.prototype, "startDescription", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], IntervalsInputComponent.prototype, "endDisabled", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], IntervalsInputComponent.prototype, "startDisabled", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], IntervalsInputComponent.prototype, "endMaximum", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], IntervalsInputComponent.prototype, "startMaximum", void 0);
__decorate([
    Input(),
    __metadata("design:type", String)
], IntervalsInputComponent.prototype, "endMaximumText", void 0);
__decorate([
    Input(),
    __metadata("design:type", String)
], IntervalsInputComponent.prototype, "startMaximumText", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], IntervalsInputComponent.prototype, "endMinimum", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], IntervalsInputComponent.prototype, "startMinimum", void 0);
__decorate([
    Input(),
    __metadata("design:type", String)
], IntervalsInputComponent.prototype, "endMinimumText", void 0);
__decorate([
    Input(),
    __metadata("design:type", String)
], IntervalsInputComponent.prototype, "startMinimumText", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], IntervalsInputComponent.prototype, "endRequired", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], IntervalsInputComponent.prototype, "startRequired", void 0);
__decorate([
    Input(),
    __metadata("design:type", String)
], IntervalsInputComponent.prototype, "endRequiredText", void 0);
__decorate([
    Input(),
    __metadata("design:type", String)
], IntervalsInputComponent.prototype, "startRequiredText", void 0);
__decorate([
    Input(),
    __metadata("design:type", String)
], IntervalsInputComponent.prototype, "endShowDeclarationText", void 0);
__decorate([
    Input(),
    __metadata("design:type", String)
], IntervalsInputComponent.prototype, "startShowDeclarationText", void 0);
__decorate([
    Input(),
    __metadata("design:type", Boolean)
], IntervalsInputComponent.prototype, "endShowValidationErrorMessages", void 0);
__decorate([
    Input(),
    __metadata("design:type", Boolean)
], IntervalsInputComponent.prototype, "startShowValidationErrorMessages", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], IntervalsInputComponent.prototype, "model", void 0);
__decorate([
    Output(),
    __metadata("design:type", EventEmitter)
], IntervalsInputComponent.prototype, "modelChange", void 0);
IntervalsInputComponent = __decorate([
    Component({
        animations: [defaultAnimation()],
        changeDetection: ChangeDetectionStrategy[CHANGE_DETECTION_STRATEGY_NAME],
     ...
     */
    ,
    __metadata("design:paramtypes", [DataScopeService, Object])
], IntervalsInputComponent);
export { IntervalsInputComponent };
// // / endregion
// // endregion
// // region text/selection
let CodeEditorComponent = CodeEditorComponent_1 = 
/* eslint-disable brace-style */
/**
 ...
 */
class CodeEditorComponent extends AbstractValueAccessor {
    /**
     ...
     * @returns Nothing.
     */
    constructor(extendObjectPipe, injector, tools) {
        super(injector);
        ...
        else if (typeof this.constructor.applicationInterfaceLoad !== 'object')
            this.constructor.applicationInterfaceLoad = Promise.all([
                new Promise((resolve) => this.tools.$(`<link
                ...
                new Promise((resolve, reject) => this.tools.$.ajax({
                    cache: true,
                    dataType: 'script',
                    error: reject,
                    success: () => {
    ...
    async ngAfterViewInit() {
        ...
        if (this.configuration.mode)
            if (this.constructor.modesLoad.hasOwnProperty(this.configuration.mode)) {
                if (this.constructor.modesLoad[this.configuration.mode] !== true)
                    try {
        ...
        const configuration = this.extendObject({}, this.configuration, { readOnly: this.disabled === null ? (this.model.disabled || model.mutable === false ||
                model.writable === false) : this.disabled });
        delete configuration.path;
        this.instance = this.codeMirror.fromTextArea(this.hostDomNode.nativeElement, configuration);
        this.instance.setValue(this.model);
        this.instance.on('blur', (instance, event) => this.blur.emit({ event, instance }));
        this.instance.on('change', () => {
            this.model = this.onChangeCallback(this.import(this.instance.getValue()));
            this.modelChange.emit(this.model);
        });
        this.instance.on('focus', (instance, event) => this.focus.emit({ event, instance }));
...
__decorate([
    Input(),
    __metadata("design:type", Object)
], CodeEditorComponent.prototype, "configuration", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], CodeEditorComponent.prototype, "disabled", void 0);
__decorate([
    Output(),
    __metadata("design:type", EventEmitter)
], CodeEditorComponent.prototype, "focus", void 0);
__decorate([
    ViewChild('hostDomNode'),
    __metadata("design:type", ElementRef)
], CodeEditorComponent.prototype, "hostDomNode", void 0);
__decorate([
    Output(),
    __metadata("design:type", EventEmitter)
], CodeEditorComponent.prototype, "initialized", void 0);
__decorate([
    Input(),
    __metadata("design:type", String)
], CodeEditorComponent.prototype, "model", void 0);
__decorate([
    Output(),
    __metadata("design:type", EventEmitter)
], CodeEditorComponent.prototype, "modelChange", void 0);
...
__decorate([
    Input(),
    __metadata("design:type", Object)
], InputComponent.prototype, "activeEditor", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], InputComponent.prototype, "editor", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], InputComponent.prototype, "labels", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], InputComponent.prototype, "maximumNumberOfRows", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], InputComponent.prototype, "minimumNumberOfRows", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
...
__decorate([
    Input(),
    __metadata("design:type", Object)
], InputComponent.prototype, "selectableEditor", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
 ...
 * @property type - Optionally defines an input type explicitly.
 */
class SimpleInputComponent extends AbstractNativeInputComponent {
    /**
     * Delegates injected injector service instance to the super constructor.
     * @param injector - Injected injector service instance.
     * @returns Nothing.
...
__decorate([
    Input(),
    __metadata("design:type", Object)
], SimpleInputComponent.prototype, "labels", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], SimpleInputComponent.prototype, "type", void 0);
 ...
 * @property selectableEditor - Indicates whether an editor is selectable.
 */
class TextareaComponent extends AbstractNativeInputComponent {
    /**
    ...
    ngOnInit(...additionalParameter) {
        ...
        if (typeof this.editor === 'object' && this.editor !== null)
            if (this.editorType.startsWith('code') || this.editor.indentUnit)
                this.editor = this._extendObject(true, {}, CODE_MIRROR_DEFAULT_OPTIONS, this.constructor.defaultEditorOptions.code, this.editor);
            else
                this.editor = this._extendObject(true, {}, TINY_MCE_DEFAULT_OPTIONS, this.constructor.defaultEditorOptions.markup, this.editor);
        else
            this.selectableEditor = false;
    }
};
...
__decorate([
    Input(),
    __metadata("design:type", Object)
], TextareaComponent.prototype, "activeEditor", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], TextareaComponent.prototype, "editor", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], TextareaComponent.prototype, "maximumNumberOfRows", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], TextareaComponent.prototype, "minimumNumberOfRows", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
...
__decorate([
    Input(),
    __metadata("design:type", Object)
], TextareaComponent.prototype, "selectableEditor", void 0);
TextareaComponent = __decorate([
     ...
     */
    ,
    __metadata("design:paramtypes", [InitialDataService, Injector])
], TextareaComponent);
 ...
 * method.
 */
class FileInputComponent /* implements AfterViewInit, OnChanges */ {
    /**
     * Sets needed services as property values.
     * @param data - Injected data service instance.
     * @param domSanitizer - Injected dom sanitizer service instance.
     ...
     * @returns Nothing.
     */
    constructor(data, domSanitizer, extendObjectPipe, getFilenameByPrefixPipe, initialData, representObjectPipe, stringFormatPipe, tools) {
    ...
    determinePresentationType() {
        if (this.file && this.file.content_type)
            if (this.constructor.textMimeTypeRegularExpression.test(this.file.content_type))
                this.file.type = 'text';
            else if (this.constructor.imageMimeTypeRegularExpression.test(this.file.content_type))
                this.file.type = 'image';
            else if (this.constructor.videoMimeTypeRegularExpression.test(this.file.content_type))
                ...
                if (!this.file.source) {
                    ...
                    if (this.revision &&
                        ...
                        try {
                            ...
                            model[attachmentTypeName][internalName].state.errors.database = ('message' in error) ? error.message : this._representObject(error);
                            return;
                        }
                    else
                        this.file.source =
...
__decorate([
    Input(),
    __metadata("design:type", String)
], FileInputComponent.prototype, "deleteButtonText", void 0);
__decorate([
    Input(),
    __metadata("design:type", String)
], FileInputComponent.prototype, "downloadButtonText", void 0);
__decorate([
    Input(),
    __metadata("design:type", Boolean)
], FileInputComponent.prototype, "editableName", void 0);
__decorate([
    Output(),
    __metadata("design:type", EventEmitter)
], FileInputComponent.prototype, "fileChange", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], FileInputComponent.prototype, "headerText", void 0);
__decorate([
    ViewChild('input'),
    __metadata("design:type", ElementRef)
...
__decorate([
    Input(),
    __metadata("design:type", String)
], FileInputComponent.prototype, "resetNameText", void 0);
__decorate([
    Input(),
    __metadata("design:type", String)
], FileInputComponent.prototype, "saveNameText", void 0);
__decorate([
    Input(),
    __metadata("design:type", String)
], FileInputComponent.prototype, "showDeclarationText", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], FileInputComponent.prototype, "mapNameToField", void 0);
__decorate([
    Input(),
    __metadata("design:type", String)
], FileInputComponent.prototype, "maximumSizeText", void 0);
__decorate([
    Input(),
    __metadata("design:type", String)
], FileInputComponent.prototype, "minimumSizeText", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], FileInputComponent.prototype, "model", void 0);
__decorate([
    Output(),
    __metadata("design:type", EventEmitter)
], FileInputComponent.prototype, "modelChange", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
...
__decorate([
    Input(),
    __metadata("design:type", String)
], FileInputComponent.prototype, "namePatternText", void 0);
__decorate([
    Input(),
    __metadata("design:type", String)
], FileInputComponent.prototype, "newButtonText", void 0);
__decorate([
    Input(),
    __metadata("design:type", String)
], FileInputComponent.prototype, "noFileText", void 0);
__decorate([
    Input(),
    __metadata("design:type", String)
], FileInputComponent.prototype, "noPreviewText", void 0);
__decorate([
    Input(),
    __metadata("design:type", String)
], FileInputComponent.prototype, "requiredText", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], FileInputComponent.prototype, "revision", void 0);
__decorate([
    Input(),
    __metadata("design:type", Boolean)
], FileInputComponent.prototype, "showValidationErrorMessages", void 0);
__decorate([
    Input(),
    __metadata("design:type", Object)
], FileInputComponent.prototype, "synchronizeImmediately", void 0);
__decorate([
    Input(),
    __metadata("design:type", String)
], FileInputComponent.prototype, "typePatternText", void 0);
FileInputComponent = __decorate([
    ...
    __metadata("design:paramtypes", [DataService,
        DomSanitizer, Object, GetFilenameByPrefixPipe,
        InitialDataService, Object, Object, ToolsService])
], FileInputComponent);
...
__decorate([
    Input(),
    __metadata("design:type", Number)
], PaginationComponent.prototype, "pageRangeLimit", void 0);
__decorate([
    Input(),
    __metadata("design:type", Number)
...
Module = __decorate([
    NgModule({
        declarations: Object.keys(module.exports).filter((name) => !name.startsWith('Abstract') &&
        ...
        providers: determineProviders(module).concat(DatePipe /* TODO,
        {
...
var DataService_1, DateTimeValueAccessor_1, CodeEditorComponent_1;
